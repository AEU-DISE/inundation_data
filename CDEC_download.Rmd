...
There is a cder package for interfacing with cdec https://cran.rstudio.com/web/packages/cder/cder.pdf 
...
Write data 
```{r}
write_csv(sensors_df, "Data/Stage_raw.csv") #write data
saveRDS(sensors_df, "Data/Stage_raw.rds") #write rds
```
